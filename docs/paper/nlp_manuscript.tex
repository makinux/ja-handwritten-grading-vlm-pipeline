% 予稿ドラフト(v0.2 の LaTeX 整形版・投稿先未定)
% -------------------------------------------------------------
% 注意: 投稿先確定後に当該会議の公式スタイルファイルへ差し替える。
% 下の「公式スタイル差し替え点」に従い切り替えるだけで本文はそのまま使える。
...
\includegraphics[width=\textwidth]{fig/fig1_pipeline}
...
\begin{figure*}[t]\centering
\includegraphics[width=\textwidth]{fig/fig2_identifiability}
...
\begin{figure*}[t]\centering
\includegraphics[width=\textwidth]{fig/fig3_example_pair}
